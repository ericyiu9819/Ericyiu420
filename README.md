...
The installer first downloads the prebuilt `proxy-server-linux-amd64` binary from the latest GitHub Release. If no Release binary exists yet, it falls back to a local build or local binary.
